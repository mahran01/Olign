...
import { StyleSheet, KeyboardAvoidingView, ActivityIndicator, Platform } from 'react-native';
import { useAuthContext } from '@/contexts';
import { Input, Text, View, Button, Form, H4, Spinner, YStack, Label, XStack, XGroup, Theme } from 'tamagui';
import { useForm, Controller, useFormState, useWatch } from 'react-hook-form';
import { Stack, useRouter } from 'expo-router';
import { Activity, Airplay, AlertCircle } from '@tamagui/lucide-icons';
