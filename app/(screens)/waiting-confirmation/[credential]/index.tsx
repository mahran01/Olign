...
import { AtSign, CloudMoon, CloudSun, Pencil } from '@tamagui/lucide-icons';
import { useLocalSearchParams, useRouter } from 'expo-router';
import { useForm } from 'react-hook-form';
import { Avatar, Button, Form, Input, Spinner, useTheme, View, XGroup, Text, ScrollView, H2, H4, H6, H5, YStack, XStack } from 'tamagui';
